    ...
    return Scaffold(
      ...
      body:tasks.isEmpty? Column(
        ...
        children: [
          ...
          SizedBox(height: 70,),
          Text('No tasks', style: TextStyle(color: Colors.blue, fontSize: 20, fontWeight: FontWeight.bold),)
        ],
        ...
        child: ListView.builder(
            ...
            itemBuilder: (context,index){
              return Slidable(
                ...
                child: HomeItem(tasks[index], widget.time, widget.taskName, () {notificationss = !notificationss;
                  setState(() {});},notificationss, () {
                    circlee = !circlee;
                    setState(() {});
                  }, circlee,
                ),
